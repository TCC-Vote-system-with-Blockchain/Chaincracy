...
describe("Chaincracy", async function () {
  ...
  it("Deve permitir a votação", async function () {
  ...
  it("Deve retornar os candidatos do cargo", async function () {
    ...
    await expect(candidatos).to.include('Candidato 1');
    await expect(candidatos).to.include('Candidato 2');
    await expect(candidatos).to.include('Candidato 3');
  });
  ...
  it("Não deve conseguir votar caso a eleição já esteja finalizada", async function () {
    await chaincracy.adicionarCargo('Presidente');
    await chaincracy.adicionarCandidato(0, 1, 'Candidato 1', 'img1');
